...
cp -f /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/output/qcache/AN/modelsim.ini .

# $vlib_exec /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/./work
if($status == 0) then
  $vmap_exec -modelsimini modelsim.ini work /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/./work
else
  echo "** Error: Library mapping failed. (Command: 'vlib /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/./work')"
endif
...
# endif
# $vlib_exec /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/.//output/qcache/AN/zin_vopt_work
if($status == 0) then
  $vmap_exec -modelsimini modelsim.ini z0in_work_ctrl /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/.//output/qcache/AN/zin_vopt_work
else
  echo "** Error: Library mapping failed. (Command: 'vlib /rsgs/pool0/eldrick/sqed_sss/demos/ridecore_demo/.//output/qcache/AN/zin_vopt_work')"
endif
